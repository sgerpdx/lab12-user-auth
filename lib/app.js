...
app.get('/plans', async (req, res) => {
  try {
    const data = await client.query('SELECT * from plans');
...
//         planets.id,
//         planets.planet,
//         types.name as planet_type,
//         planets.diameter,
//         planets.gravity,
//         planets.magnetic_field_strong,
//         planets.owner_id,
//         planets.type_id
//       from planets
//       JOIN types
//       ON planets.type_id = types.id 
//       WHERE planets.id=$1
//       `, [id]);
...
//     const data = await client.query(`
//     UPDATE planets 
//     SET planet=$1, diameter=$2, gravity=$3, magnetic_field_strong=$4, owner_id=$5, type_id=$6
//     WHERE id = $7
//     RETURNING *
//     `,
//       [
